...
2. Design the DuckDB tables following `30-*-phase-test.md` (idempotent `INSERT OR REPLACE`).
3. Define Pydantic models for incoming data following `30-*-phase-test.md`.
