...
### Phase 5: Lossless Compression (JPEG)
1. You MUST execute a Python snippet using the `Pillow` library to convert all newly generated `docs/assets/*.png` files into high-quality `.jpg` format.
...
3. You MUST update `README.md` and any other references to point to the `.jpg` files instead of `.png`.
