...
- [ ] **Tier 1 Security (`20-*-phase-execute.md`, `20-*-phase-execute.md`)**
  - Are all user inputs rigorously sanitized (CWE-74)?
  - Are we absolutely sure no API keys or secrets are hardcoded?
- [ ] **Tier 2 Correctness (`30-*-phase-test.md`, `30-*-phase-test.md`)**
...
- [ ] **Tier 3 Compliance (Platform & SRE Constraints)**
  ...
  - Have all SAST compliance standards (`20-*-phase-execute.md`) been accounted for?
- [ ] **Tier 4 Style (`10-phase-audit.md`)**
