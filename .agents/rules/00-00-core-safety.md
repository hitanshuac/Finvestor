...
Because the Antigravity repository relies heavily on autonomous execution, any future AI Agent tasked with creating or modifying a rule in `.agents/rules/` MUST strictly adhere to the **Rule Entry Template** defined in `30-MASTER-compliance-and-deploy.md`.
