...
|---|---|---|---|
| **0** | **Safety (Data Integrity)** | `00-MASTER-safety-and-guardrails.md` | Preventing data loss is non-negotiable |
| **1** | **Security** | `10-MASTER-security-and-mlsecops.md` | Security vulnerabilities are career-ending |
| **2** | **Correctness** | `20-MASTER-correctness-and-data.md` | Correct behavior trumps style and compliance |
| **3** | **Compliance** | `30-MASTER-compliance-and-deploy.md` | Platform rules are important but negotiable in implementation |
| **4** | **Style** | `40-MASTER-style-and-quality.md` | Code style is the least critical dimension |
